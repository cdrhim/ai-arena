...
test("a linked team receives an accessible field-level privacy editor", () => {
  assert.match(client, /team\.isViewerTeam && hub\?\.permissions\?\.canEditTeamCardVisibility/);
  ...
  assert.match(client, /postProgramAction\("updateTeamCardVisibility", \{ fields \}, \{ signal: controller\.signal \}\)/);
